...
<script src="resources/js/controlerapp.js" type="text/javascript"></script>
<form>
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<ul class="nav navbar-top-links navbar-right" ng-show="false">
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="#/inicio" ><i class="fa fa-dashboard fa-fw"></i>
						Inicio</a></li>
				<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
						Seguridad<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="#/seguridad">Usuarios</a></li>
						<li><a href ng-click="rolesMenu()">Roles</a></li>
